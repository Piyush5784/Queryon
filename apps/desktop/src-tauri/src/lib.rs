...
pub fn run() {
    let builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        commands::schema::db_list_constraints,
        commands::schema::db_get_table_ddl,
        commands::schema::db_render_ddl,
        commands::schema::db_execute_ddl,
